...
public class LumaComponentTest {
  ...
  @Test
  public void execute() {
    new LumaComponent().execute(model1);
    ...
    assertEquals(model1.getPixelAt(1,1).getRed(), 142);
    assertEquals(model1.getPixelAt(1,1).getGreen(), 142);
    assertEquals(model1.getPixelAt(1,1).getBlue(), 142);
  ...
  public void testInvalidConstructor() {
    try {
      ...
      new LumaComponent().execute(null);
      fail();
