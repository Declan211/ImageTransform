...
public class VerticalFlipTest {
  ...
  @Test
  public void execute() {
    new VerticalFlip().execute(model1);

    assertEquals(model1.getPixelAt(0,0).getRed(), 1);
    assertEquals(model1.getPixelAt(0,0).getGreen(), 1);
    assertEquals(model1.getPixelAt(0,0).getBlue(), 2);
    ...
    assertEquals(model1.getPixelAt(0,2).getRed(), 250);
    assertEquals(model1.getPixelAt(0,2).getGreen(), 123);
    assertEquals(model1.getPixelAt(0,2).getBlue(), 250);

    assertEquals(model1.getPixelAt(1,0).getRed(), 90);
    assertEquals(model1.getPixelAt(1,0).getGreen(), 90);
    assertEquals(model1.getPixelAt(1,0).getBlue(), 90);
    ...
    assertEquals(model1.getPixelAt(1,2).getRed(), 100);
    assertEquals(model1.getPixelAt(1,2).getGreen(), 150);
    assertEquals(model1.getPixelAt(1,2).getBlue(), 200);

    assertEquals(model1.getPixelAt(2,0).getRed(), 126);
    assertEquals(model1.getPixelAt(2,0).getGreen(), 240);
    assertEquals(model1.getPixelAt(2,0).getBlue(), 0);

    assertEquals(model1.getPixelAt(2,1).getRed(), 100);
    assertEquals(model1.getPixelAt(2,1).getGreen(), 90);
    assertEquals(model1.getPixelAt(2,1).getBlue(), 80);

    assertEquals(model1.getPixelAt(2,2).getRed(), 0);
    assertEquals(model1.getPixelAt(2, 2).getGreen(), 109);
    assertEquals(model1.getPixelAt(2,2).getBlue(), 57);
